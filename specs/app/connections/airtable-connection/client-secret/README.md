...
Confidential credential used to authenticate the application during OAuth 2.0 token exchange with Airtable. This secret proves the application's identity and must be kept secure at all times.
...
```json
{
  "clientSecret": "secret_airtable_abc123xyz789"
}
```
...
&client_id=airtable_client_abc123
&client_secret=secret_airtable_xyz789
