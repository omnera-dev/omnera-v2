...
Confidential credential used to authenticate the application during OAuth 2.0 token exchange with Notion. This secret proves the application's identity and must be kept secure at all times.
...
```json
{
  "clientSecret": "secret_notion_abc123xyz789"
}
```
...
```http
POST https://notion.com/oauth2/v1/token
Content-Type: application/x-www-form-urlencoded

grant_type=authorization_code
&code=AUTH_CODE_FROM_CALLBACK
&client_id=notion_client_abc123
&client_secret=secret_notion_xyz789
