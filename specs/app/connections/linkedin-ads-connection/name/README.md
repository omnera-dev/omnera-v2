...
```json
{
  "name": "My LinkedIn Ads Workspace"
}
```
...
- **Descriptive**: Include workspace, team, or environment context
  - Good: "Marketing LinkedIn Ads - Production"
  - Bad: "Connection 1"
...
```json
[
  { "name": "LinkedIn Ads - Development" },
  { "name": "LinkedIn Ads - Staging" },
  { "name": "LinkedIn Ads - Production" }
]
```
