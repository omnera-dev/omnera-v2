...
```json
{
  "clientId": "app.sovrium.google-sheets.1234567890"
}
```
...
```
Integration Name: Sovrium Google Sheets Integration
Client ID: google-sheets_client_abc123xyz
Redirect URI: https://app.sovrium.io/oauth/google-sheets/callback
