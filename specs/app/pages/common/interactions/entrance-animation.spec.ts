...
test.describe('Entrance Animation', () => {
  ...
  test.fixme(
    ...
    async ({ page, startServerWithSchema }) => {
      // Spec ID: APP-INTERACTION-ENTRANCE-001
  ...
  test.fixme(
    ...
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // Spec ID: APP-INTERACTION-ENTRANCE-002
  ...
  test.fixme(
    ...
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // Spec ID: APP-INTERACTION-ENTRANCE-003
  ...
  test.fixme(
    ...
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // Spec ID: APP-INTERACTION-ENTRANCE-004
  ...
  test.fixme(
    ...
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // Spec ID: APP-INTERACTION-ENTRANCE-005
  ...
  test.fixme(
    ...
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // Spec ID: APP-INTERACTION-ENTRANCE-006
  ...
  test.fixme(
    ...
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // Spec ID: APP-INTERACTION-ENTRANCE-007
  ...
  test.fixme(
    ...
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // Spec ID: APP-INTERACTION-ENTRANCE-008
