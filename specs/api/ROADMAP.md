...
| ⏳ | API-TABLES-RECORDS-LIST-001 | **Given** A running server with existing records, **When** User requests list of records, **Then*... | `specs/api/paths/tables/{tableId}/records/get.json` | - |
