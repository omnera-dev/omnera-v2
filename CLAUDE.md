...
4. **Unit Tests**: Run `bun test`
   - Executes all test suites
   - Ensures functionality works correctly
   - Must have all tests passing

5. **Review Changes**: Run `git diff` and `git status`
...
4. **Tests last** - Verifies functionality after all fixes
...
1. **Linting first** - Catches code quality issues early (faster than type checking)
2. **Formatting second** - Verifies code style consistency
3. **Type checking third** - Comprehensive type validation (slower)
4. **Tests last** - Full functionality verification (slowest)
...
- **Current State**: Complete development toolchain (execution, linting, validation, formatting, testing, cleanup)
...
5. **Testing**: Bun test runner validates functionality
6. **Cleanup**: Knip detects and removes unused code periodically
