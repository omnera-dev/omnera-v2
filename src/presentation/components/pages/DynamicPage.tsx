          ...
          >
            ...
            >
              {page.sections.length === 0 && blocks && blocks.length > 0
                ...
                : page.sections.length === 0 && theme?.colors
                  ? // Color showcase mode - render color swatches when sections is empty and colors exist
                      ...
                      const blockInfo: { name: string; instanceIndex?: number } | undefined =
                        (() => {
                          ...
                          const totalOccurrences = page.sections.filter((s) => {
                            const sBlockName =
                              'block' in s ? s.block : '$ref' in s ? s.$ref : undefined
