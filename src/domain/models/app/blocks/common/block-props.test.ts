...
import { BlockPropsSchema, BlockPropValueSchema } from './block-props'

describe('BlockPropValueSchema', () => {
  test('should accept string values', () => {
    // GIVEN: String property value
    const value = 'text-$color bg-$bgColor'

    // WHEN: Schema validation is performed
    const result = Schema.decodeUnknownSync(BlockPropValueSchema)(value)
  ...
  test('should accept boolean values', () => {
    ...
    // WHEN: Schema validation is performed
    const result1 = Schema.decodeUnknownSync(BlockPropValueSchema)(trueValue)
    const result2 = Schema.decodeUnknownSync(BlockPropValueSchema)(falseValue)
...
describe('BlockPropsSchema', () => {
  test('should accept props with string values', () => {
    ...
    // WHEN: Schema validation is performed
    const result = Schema.decodeUnknownSync(BlockPropsSchema)(props)
