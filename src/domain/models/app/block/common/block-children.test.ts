...
import { BlockChildElementSchema, BlockChildrenSchema } from './block-children'

describe('BlockChildElementSchema', () => {
  test('should accept element with only type', () => {
    ...
    const result = Schema.decodeUnknownSync(BlockChildElementSchema)(element)
  ...
  test('should reject element without type', () => {
    ...
    expect(() => Schema.decodeUnknownSync(BlockChildElementSchema)(element)).toThrow()
  })
})

describe('BlockChildrenSchema', () => {
