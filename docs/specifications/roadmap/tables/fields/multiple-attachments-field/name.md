# Tables.fields.multiple-attachments-field.name
...
### Tables.fields.multiple-attachments-field.name Schema

**Location**: `src/domain/models/app/tables.fields.multiple-attachments-field.name.ts`
...
```typescript
export const Tables.fields.multiple-attachments-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.multiple-attachments-field.name = Schema.Schema.Type<typeof Tables.fields.multiple-attachments-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.multiple-attachments-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.multiple-attachments-field.name in the application
