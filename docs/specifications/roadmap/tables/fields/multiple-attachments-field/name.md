...
```typescript
export const TablesFieldsMultipleAttachmentsFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsMultipleAttachmentsFieldName = Schema.Schema.Type<typeof TablesFieldsMultipleAttachmentsFieldNameSchema>
```
