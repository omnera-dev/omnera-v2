...
```typescript
export const TablesFieldsUpdatedByFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsUpdatedByFieldName = Schema.Schema.Type<typeof TablesFieldsUpdatedByFieldNameSchema>
```
