# Tables.fields.updated-by-field.name
...
### Tables.fields.updated-by-field.name Schema

**Location**: `src/domain/models/app/tables.fields.updated-by-field.name.ts`
...
```typescript
export const Tables.fields.updated-by-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.updated-by-field.name = Schema.Schema.Type<typeof Tables.fields.updated-by-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.updated-by-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.updated-by-field.name in the application
