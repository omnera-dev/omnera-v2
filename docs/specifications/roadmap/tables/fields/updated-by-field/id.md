# Tables.fields.updated-by-field.id
...
```typescript
export const TablesFieldsUpdatedByFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsUpdatedByFieldId = Schema.Schema.Type<typeof TablesFieldsUpdatedByFieldIdSchema>
```
