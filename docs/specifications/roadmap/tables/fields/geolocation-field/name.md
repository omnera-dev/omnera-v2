...
```typescript
export const TablesFieldsGeolocationFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsGeolocationFieldName = Schema.Schema.Type<typeof TablesFieldsGeolocationFieldNameSchema>
```
