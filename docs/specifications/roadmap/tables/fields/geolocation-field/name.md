# Tables.fields.geolocation-field.name
...
### Tables.fields.geolocation-field.name Schema

**Location**: `src/domain/models/app/tables.fields.geolocation-field.name.ts`
...
```typescript
export const Tables.fields.geolocation-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.geolocation-field.name = Schema.Schema.Type<typeof Tables.fields.geolocation-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.geolocation-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.geolocation-field.name in the application
