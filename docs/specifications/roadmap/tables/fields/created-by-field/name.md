# Tables.fields.created-by-field.name
...
```typescript
export const TablesFieldsCreatedByFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsCreatedByFieldName = Schema.Schema.Type<typeof TablesFieldsCreatedByFieldNameSchema>
```
