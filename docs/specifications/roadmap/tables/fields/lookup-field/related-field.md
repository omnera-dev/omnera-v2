# Tables.fields.lookup-field.relatedField
...
export type TablesFieldsLookupFieldRelatedField = Schema.Schema.Type<
  typeof TablesFieldsLookupFieldRelatedFieldSchema
>
```
