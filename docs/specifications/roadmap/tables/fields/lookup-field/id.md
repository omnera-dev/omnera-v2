...
```typescript
export const TablesFieldsLookupFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsLookupFieldId = Schema.Schema.Type<typeof TablesFieldsLookupFieldIdSchema>
```
