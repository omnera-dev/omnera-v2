...
```typescript
export const TablesFieldsFormulaFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsFormulaFieldId = Schema.Schema.Type<typeof TablesFieldsFormulaFieldIdSchema>
```
