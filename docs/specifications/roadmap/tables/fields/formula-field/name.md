...
```typescript
export const Tables.fields.formula-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.formula-field.name = Schema.Schema.Type<typeof Tables.fields.formula-field.nameSchema>
```
