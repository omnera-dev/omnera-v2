...
```typescript
export const TablesFieldsCheckboxFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsCheckboxFieldId = Schema.Schema.Type<typeof TablesFieldsCheckboxFieldIdSchema>
```
