...
```typescript
export const TablesFieldsCheckboxFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsCheckboxFieldName = Schema.Schema.Type<typeof TablesFieldsCheckboxFieldNameSchema>
```
