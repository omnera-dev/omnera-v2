# Tables.fields.checkbox-field.name
...
### Tables.fields.checkbox-field.name Schema

**Location**: `src/domain/models/app/tables.fields.checkbox-field.name.ts`
...
```typescript
export const Tables.fields.checkbox-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.checkbox-field.name = Schema.Schema.Type<typeof Tables.fields.checkbox-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.checkbox-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.checkbox-field.name in the application
