...
### Tables.fields.number-field.id Schema

**Location**: `src/domain/models/app/tables.fields.number-field.id.ts`
...
```typescript
export const Tables.fields.number-field.idSchema = Schema.Int.pipe(
...
export type Tables.fields.number-field.id = Schema.Schema.Type<typeof Tables.fields.number-field.idSchema>
```
...
**Test File**: `tests/app/tables.fields.number-field.id.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.number-field.id in the application
