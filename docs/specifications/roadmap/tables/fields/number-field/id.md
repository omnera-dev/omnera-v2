...
```typescript
export const TablesFieldsNumberFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsNumberFieldId = Schema.Schema.Type<typeof TablesFieldsNumberFieldIdSchema>
```
