...
```typescript
export const TablesFieldsNumberFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsNumberFieldName = Schema.Schema.Type<typeof TablesFieldsNumberFieldNameSchema>
```
