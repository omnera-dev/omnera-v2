# Tables.fields.number-field.name
...
### Tables.fields.number-field.name Schema

**Location**: `src/domain/models/app/tables.fields.number-field.name.ts`
...
```typescript
export const Tables.fields.number-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.number-field.name = Schema.Schema.Type<typeof Tables.fields.number-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.number-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.number-field.name in the application
