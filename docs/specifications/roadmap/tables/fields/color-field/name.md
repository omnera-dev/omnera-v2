# Tables.fields.color-field.name
...
### Tables.fields.color-field.name Schema

**Location**: `src/domain/models/app/tables.fields.color-field.name.ts`
...
```typescript
export const Tables.fields.color-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.color-field.name = Schema.Schema.Type<typeof Tables.fields.color-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.color-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.color-field.name in the application
