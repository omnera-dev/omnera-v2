...
```typescript
export const TablesFieldsColorFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsColorFieldName = Schema.Schema.Type<typeof TablesFieldsColorFieldNameSchema>
```
