...
```typescript
export const TablesFieldsColorFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsColorFieldId = Schema.Schema.Type<typeof TablesFieldsColorFieldIdSchema>
```
