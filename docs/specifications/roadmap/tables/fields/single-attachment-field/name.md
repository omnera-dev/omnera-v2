# Tables.fields.single-attachment-field.name
...
### Tables.fields.single-attachment-field.name Schema

**Location**: `src/domain/models/app/tables.fields.single-attachment-field.name.ts`
...
export type TablesFieldsSingleAttachmentFieldName = Schema.Schema.Type<
  typeof TablesFieldsSingleAttachmentFieldNameSchema
>
```
...
**Test File**: `tests/app/tables.fields.single-attachment-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.single-attachment-field.name in the application
