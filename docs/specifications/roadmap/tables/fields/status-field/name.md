# Tables.fields.status-field.name
...
### Tables.fields.status-field.name Schema

**Location**: `src/domain/models/app/tables.fields.status-field.name.ts`
...
```typescript
export const Tables.fields.status-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.status-field.name = Schema.Schema.Type<typeof Tables.fields.status-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.status-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.status-field.name in the application
