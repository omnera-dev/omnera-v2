...
```typescript
export const TablesFieldsStatusFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsStatusFieldName = Schema.Schema.Type<typeof TablesFieldsStatusFieldNameSchema>
```
