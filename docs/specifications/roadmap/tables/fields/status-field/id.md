...
### Tables.fields.status-field.id Schema

**Location**: `src/domain/models/app/tables.fields.status-field.id.ts`
...
```typescript
export const Tables.fields.status-field.idSchema = Schema.Int.pipe(
...
export type Tables.fields.status-field.id = Schema.Schema.Type<typeof Tables.fields.status-field.idSchema>
```
...
**Test File**: `tests/app/tables.fields.status-field.id.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.status-field.id in the application
