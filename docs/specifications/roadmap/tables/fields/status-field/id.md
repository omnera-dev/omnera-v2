...
```typescript
export const TablesFieldsStatusFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsStatusFieldId = Schema.Schema.Type<typeof TablesFieldsStatusFieldIdSchema>
```
