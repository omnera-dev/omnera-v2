...
### Tables.fields.text-field.name Schema

**Location**: `src/domain/models/app/tables.fields.text-field.name.ts`
...
```typescript
export const Tables.fields.text-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.text-field.name = Schema.Schema.Type<typeof Tables.fields.text-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.text-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.text-field.name in the application
