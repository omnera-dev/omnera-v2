...
```typescript
export const TablesFieldsTextFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsTextFieldName = Schema.Schema.Type<typeof TablesFieldsTextFieldNameSchema>
```
