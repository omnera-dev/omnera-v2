...
```typescript
export const TablesFieldsArrayFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsArrayFieldId = Schema.Schema.Type<typeof TablesFieldsArrayFieldIdSchema>
```
