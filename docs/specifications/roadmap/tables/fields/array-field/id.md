...
### Tables.fields.array-field.id Schema

**Location**: `src/domain/models/app/tables.fields.array-field.id.ts`
...
```typescript
export const Tables.fields.array-field.idSchema = Schema.Int.pipe(
...
export type Tables.fields.array-field.id = Schema.Schema.Type<typeof Tables.fields.array-field.idSchema>
```
...
**Test File**: `tests/app/tables.fields.array-field.id.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.array-field.id in the application
