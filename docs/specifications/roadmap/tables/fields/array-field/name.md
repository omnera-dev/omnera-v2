# Tables.fields.array-field.name
...
```typescript
export const TablesFieldsArrayFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsArrayFieldName = Schema.Schema.Type<typeof TablesFieldsArrayFieldNameSchema>
```
