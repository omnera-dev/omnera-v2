# Tables.fields.button-field.name
...
```typescript
export const TablesFieldsButtonFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsButtonFieldName = Schema.Schema.Type<typeof TablesFieldsButtonFieldNameSchema>
```
