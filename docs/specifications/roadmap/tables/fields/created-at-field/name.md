...
```typescript
export const TablesFieldsCreatedAtFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsCreatedAtFieldName = Schema.Schema.Type<typeof TablesFieldsCreatedAtFieldNameSchema>
```
