...
```typescript
export const TablesFieldsMultiSelectFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsMultiSelectFieldId = Schema.Schema.Type<typeof TablesFieldsMultiSelectFieldIdSchema>
```
