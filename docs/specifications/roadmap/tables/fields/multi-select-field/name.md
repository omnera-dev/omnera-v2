...
```typescript
export const TablesFieldsMultiSelectFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsMultiSelectFieldName = Schema.Schema.Type<typeof TablesFieldsMultiSelectFieldNameSchema>
```
