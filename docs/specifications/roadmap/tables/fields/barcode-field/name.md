# Tables.fields.barcode-field.name
...
### Tables.fields.barcode-field.name Schema

**Location**: `src/domain/models/app/tables.fields.barcode-field.name.ts`
...
```typescript
export const Tables.fields.barcode-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.barcode-field.name = Schema.Schema.Type<typeof Tables.fields.barcode-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.barcode-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.barcode-field.name in the application
