...
```typescript
export const TablesFieldsBarcodeFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsBarcodeFieldName = Schema.Schema.Type<typeof TablesFieldsBarcodeFieldNameSchema>
```
