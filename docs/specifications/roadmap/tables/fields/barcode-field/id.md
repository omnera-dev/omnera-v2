# Tables.fields.barcode-field.id
...
```typescript
export const Tables.fields.barcode-field.idSchema = Schema.Int.pipe(
...
export type Tables.fields.barcode-field.id = Schema.Schema.Type<typeof Tables.fields.barcode-field.idSchema>
```
