...
```typescript
export const TablesFieldsUpdatedAtFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsUpdatedAtFieldName = Schema.Schema.Type<typeof TablesFieldsUpdatedAtFieldNameSchema>
```
