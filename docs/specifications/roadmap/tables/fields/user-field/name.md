...
```typescript
export const Tables.fields.user-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.user-field.name = Schema.Schema.Type<typeof Tables.fields.user-field.nameSchema>
```
