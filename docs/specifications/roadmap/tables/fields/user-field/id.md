...
```typescript
export const TablesFieldsUserFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsUserFieldId = Schema.Schema.Type<typeof TablesFieldsUserFieldIdSchema>
```
