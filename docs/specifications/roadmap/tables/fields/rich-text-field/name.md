...
```typescript
export const TablesFieldsRichTextFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsRichTextFieldName = Schema.Schema.Type<typeof TablesFieldsRichTextFieldNameSchema>
```
