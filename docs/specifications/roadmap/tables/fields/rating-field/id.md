...
```typescript
export const TablesFieldsRatingFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsRatingFieldId = Schema.Schema.Type<typeof TablesFieldsRatingFieldIdSchema>
```
