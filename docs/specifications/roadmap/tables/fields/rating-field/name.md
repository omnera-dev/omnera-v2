# Tables.fields.rating-field.name
...
### Tables.fields.rating-field.name Schema

**Location**: `src/domain/models/app/tables.fields.rating-field.name.ts`
...
```typescript
export const Tables.fields.rating-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.rating-field.name = Schema.Schema.Type<typeof Tables.fields.rating-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.rating-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.rating-field.name in the application
