...
```typescript
export const TablesFieldsRatingFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsRatingFieldName = Schema.Schema.Type<typeof TablesFieldsRatingFieldNameSchema>
```
