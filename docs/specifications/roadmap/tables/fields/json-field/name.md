...
```typescript
export const TablesFieldsJsonFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsJsonFieldName = Schema.Schema.Type<typeof TablesFieldsJsonFieldNameSchema>
```
