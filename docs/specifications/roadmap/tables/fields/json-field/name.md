...
### Tables.fields.json-field.name Schema

**Location**: `src/domain/models/app/tables.fields.json-field.name.ts`
...
```typescript
export const Tables.fields.json-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.json-field.name = Schema.Schema.Type<typeof Tables.fields.json-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.json-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.json-field.name in the application
