# Tables.fields.relationship-field.name
...
### Tables.fields.relationship-field.name Schema

**Location**: `src/domain/models/app/tables.fields.relationship-field.name.ts`
...
```typescript
export const Tables.fields.relationship-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.relationship-field.name = Schema.Schema.Type<typeof Tables.fields.relationship-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.relationship-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.relationship-field.name in the application
