...
```typescript
export const TablesFieldsRelationshipFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsRelationshipFieldName = Schema.Schema.Type<typeof TablesFieldsRelationshipFieldNameSchema>
```
