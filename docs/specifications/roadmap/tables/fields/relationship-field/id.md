# Tables.fields.relationship-field.id
...
### Tables.fields.relationship-field.id Schema

**Location**: `src/domain/models/app/tables.fields.relationship-field.id.ts`
...
export type TablesFieldsRelationshipFieldId = Schema.Schema.Type<
  typeof TablesFieldsRelationshipFieldIdSchema
>
```
...
**Test File**: `tests/app/tables.fields.relationship-field.id.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.relationship-field.id in the application
