...
```typescript
export const TablesFieldsRollupFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsRollupFieldName = Schema.Schema.Type<typeof TablesFieldsRollupFieldNameSchema>
```
