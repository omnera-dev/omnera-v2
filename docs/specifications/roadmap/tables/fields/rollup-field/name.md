# Tables.fields.rollup-field.name
...
### Tables.fields.rollup-field.name Schema

**Location**: `src/domain/models/app/tables.fields.rollup-field.name.ts`
...
```typescript
export const Tables.fields.rollup-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.rollup-field.name = Schema.Schema.Type<typeof Tables.fields.rollup-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.rollup-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.rollup-field.name in the application
