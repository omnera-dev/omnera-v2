...
```typescript
export const TablesFieldsRollupFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsRollupFieldId = Schema.Schema.Type<typeof TablesFieldsRollupFieldIdSchema>
```
