...
### Tables.fields.rollup-field.id Schema

**Location**: `src/domain/models/app/tables.fields.rollup-field.id.ts`
...
```typescript
export const Tables.fields.rollup-field.idSchema = Schema.Int.pipe(
...
export type Tables.fields.rollup-field.id = Schema.Schema.Type<typeof Tables.fields.rollup-field.idSchema>
```
...
**Test File**: `tests/app/tables.fields.rollup-field.id.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.rollup-field.id in the application
