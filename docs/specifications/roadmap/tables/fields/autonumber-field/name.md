...
```typescript
export const TablesFieldsAutonumberFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsAutonumberFieldName = Schema.Schema.Type<typeof TablesFieldsAutonumberFieldNameSchema>
```
