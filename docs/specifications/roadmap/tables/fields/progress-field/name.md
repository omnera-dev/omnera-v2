...
```typescript
export const TablesFieldsProgressFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsProgressFieldName = Schema.Schema.Type<typeof TablesFieldsProgressFieldNameSchema>
```
