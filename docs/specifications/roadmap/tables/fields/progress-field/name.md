# Tables.fields.progress-field.name
...
### Tables.fields.progress-field.name Schema

**Location**: `src/domain/models/app/tables.fields.progress-field.name.ts`
...
```typescript
export const Tables.fields.progress-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.progress-field.name = Schema.Schema.Type<typeof Tables.fields.progress-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.progress-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.progress-field.name in the application
