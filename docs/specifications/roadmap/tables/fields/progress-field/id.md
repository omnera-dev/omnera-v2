...
```typescript
export const TablesFieldsProgressFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsProgressFieldId = Schema.Schema.Type<typeof TablesFieldsProgressFieldIdSchema>
```
