# Tables.fields.single-select-field.name
...
```typescript
export const TablesFieldsSingleSelectFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsSingleSelectFieldName = Schema.Schema.Type<typeof TablesFieldsSingleSelectFieldNameSchema>
```
