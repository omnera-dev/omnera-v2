...
```typescript
export const TablesFieldsDurationFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsDurationFieldName = Schema.Schema.Type<typeof TablesFieldsDurationFieldNameSchema>
```
