# Tables.fields.duration-field.name
...
### Tables.fields.duration-field.name Schema

**Location**: `src/domain/models/app/tables.fields.duration-field.name.ts`
...
```typescript
export const Tables.fields.duration-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.duration-field.name = Schema.Schema.Type<typeof Tables.fields.duration-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.duration-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.duration-field.name in the application
