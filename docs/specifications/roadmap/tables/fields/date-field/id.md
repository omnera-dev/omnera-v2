...
```typescript
export const TablesFieldsDateFieldIdSchema = Schema.Int.pipe(
...
export type TablesFieldsDateFieldId = Schema.Schema.Type<typeof TablesFieldsDateFieldIdSchema>
```
