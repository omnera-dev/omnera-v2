...
### Tables.fields.date-field.name Schema

**Location**: `src/domain/models/app/tables.fields.date-field.name.ts`
...
```typescript
export const Tables.fields.date-field.nameSchema = Schema.String.pipe(
...
export type Tables.fields.date-field.name = Schema.Schema.Type<typeof Tables.fields.date-field.nameSchema>
```
...
**Test File**: `tests/app/tables.fields.date-field.name.spec.ts`
...
- **GIVEN**: user is configuring Tables.fields.date-field.name in the application
