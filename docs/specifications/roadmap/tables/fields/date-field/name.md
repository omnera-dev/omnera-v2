...
```typescript
export const TablesFieldsDateFieldNameSchema = Schema.String.pipe(
...
export type TablesFieldsDateFieldName = Schema.Schema.Type<typeof TablesFieldsDateFieldNameSchema>
```
