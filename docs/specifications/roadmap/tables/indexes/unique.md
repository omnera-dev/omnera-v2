...
### Tables.indexes.unique Schema

**Location**: `src/domain/models/app/tables.indexes.unique.ts`
...
**Test File**: `tests/app/tables.indexes.unique.spec.ts`
...
- **GIVEN**: user is configuring Tables.indexes.unique in the application
