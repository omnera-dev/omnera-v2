...
### Pages.form-page.table Schema

**Location**: `src/domain/models/app/pages.form-page.table.ts`
...
**Test File**: `tests/app/pages.form-page.table.spec.ts`
...
- **GIVEN**: user enters Pages.form-page.table
...
- **GIVEN**: user is configuring Pages.form-page.table in the application
...
- `[data-testid="pages.form-page.table-input"]`
- `[data-testid="pages.form-page.table-error"]`
