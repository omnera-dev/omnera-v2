...
```typescript
export const Pages.form-page.inputs.text-input.labelSchema = Schema.String

export type Pages.form-page.inputs.text-input.label = Schema.Schema.Type<typeof Pages.form-page.inputs.text-input.labelSchema>
```
