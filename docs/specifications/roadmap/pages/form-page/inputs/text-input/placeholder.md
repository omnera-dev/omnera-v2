# Pages.form-page.inputs.text-input.placeholder
...
export type PagesFormPageInputsTextInputPlaceholder = Schema.Schema.Type<
  typeof PagesFormPageInputsTextInputPlaceholderSchema
>
```
