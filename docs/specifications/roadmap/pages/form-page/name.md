...
### Pages.form-page.name Schema

**Location**: `src/domain/models/app/pages.form-page.name.ts`
...
**Test File**: `tests/app/pages.form-page.name.spec.ts`
...
- **GIVEN**: user is configuring Pages.form-page.name in the application
