 ...
 * Name of the table to display
 */
export const Pages.table-view-page.tableSchema = Schema.String.pipe(
...
export type Pages.table-view-page.table = Schema.Schema.Type<typeof Pages.table-view-page.tableSchema>
```
