# Pages.custom-html-page.head.script-element.src
...
export type PagesCustomHtmlPageHeadScriptElementSrc = Schema.Schema.Type<
  typeof PagesCustomHtmlPageHeadScriptElementSrcSchema
>
```
