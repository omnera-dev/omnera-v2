 ...
 * ```
 */
export const Pages.custom-html-page.pathSchema = Schema.String.pipe(
...
export type Pages.custom-html-page.path = Schema.Schema.Type<typeof Pages.custom-html-page.pathSchema>
````
