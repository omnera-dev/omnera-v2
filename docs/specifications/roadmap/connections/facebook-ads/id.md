...
```typescript
export const Connections.facebook-ads.idSchema = Schema.Int.pipe(
    Schema.greaterThanOrEqualTo(1),
    Schema.lessThanOrEqualTo(9007199254740991)
  )

export type Connections.facebook-ads.id = Schema.Schema.Type<typeof Connections.facebook-ads.idSchema>
```
