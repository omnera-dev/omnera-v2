...
### Connections.linked-in-ads.id Schema

**Location**: `src/domain/models/app/connections.linked-in-ads.id.ts`
...
**Test File**: `tests/app/connections.linked-in-ads.id.spec.ts`
...
- **GIVEN**: user enters Connections.linked-in-ads.id
...
- **GIVEN**: user is configuring Connections.linked-in-ads.id in the application
...
- `[data-testid="connections.linked-in-ads.id-input"]`
- `[data-testid="connections.linked-in-ads.id-error"]`
