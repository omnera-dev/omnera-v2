...
import { TableSchema } from '@/domain/models/table' // in page/index.ts
import { AutomationSchema } from '@/domain/models/automation' // in table/index.ts
```
...
import type { TableSchema } from '@/domain/models/table'
